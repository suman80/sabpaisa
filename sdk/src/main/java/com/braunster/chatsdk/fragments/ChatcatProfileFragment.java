...
//        }
    ...
    public void logout() {
     ...
     /*   Intent intent = new Intent(getActivity(), ChatSDKShareWithContactsActivity.class);
    ...
    private void setDetails(int loginType) {
        ...
        if (DEBUG)
            Timber.d("loading user details, Name: %s, Status: %s, Country: %s, Location: %s", name, status, country, location);
