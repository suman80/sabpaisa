...
public abstract class ChatSDKAbstractProfileFragment extends ChatSDKBaseFragment {
    ...
    protected CircleImageView1 profileCircleImageView1;
    ...
    public void initViews() {
        ...
        chatSDKProfileHelper = new ChatSDKProfileHelper(getActivity(), profileCircleImageView1, progressBar, chatSDKUiHelper, mainView);
    ...
    public void onResume() {
        ...
        if (clickableProfilePic)
            profileCircleImageView1.setOnClickListener(ChatSDKProfileHelper.getProfilePicClickListener(getActivity(), this));
    ...
    public void clearData() {
        ...
        if (mainView != null) {
            profileCircleImageView1.setImageBitmap(null);
            profileCircleImageView1.setImageResource(R.drawable.ic_action_user);
        }
    }
