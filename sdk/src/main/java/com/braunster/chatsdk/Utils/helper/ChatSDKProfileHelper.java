...
public class ChatSDKProfileHelper {
    ...
    public CircleImageView1 profileCircleImageView1;
    ...
    public ChatSDKProfileHelper(Activity activity, CircleImageView1 profileCircleImageView1, ProgressBar progressBar, ChatSDKUiHelper uiHelper, View mainView) {
        this.profileCircleImageView1 = profileCircleImageView1;
    ...
    public void loadProfilePic(int loginType) {
        profileCircleImageView1.setVisibility(View.GONE);
    ...
    private class PostProfilePic implements Runnable {
        ...
        public void run() {
            ...
            profileCircleImageView1.setImageBitmap(scaleImage(bitmap, size));
            progressBar.setVisibility(View.GONE);
            profileCircleImageView1.setVisibility(View.VISIBLE);
        }
    }
    ...
    public void setProfilePic(final Bitmap bitmap) {
        ...
        if (postProfilePic != null)
            profileCircleImageView1.removeCallbacks(postProfilePic);
        ...
        if (size == 0) {
            ...
            profileCircleImageView1.post(postProfilePic);
        } else {
            profileCircleImageView1.setImageBitmap(scaleImage(bitmap, size));
            progressBar.setVisibility(View.GONE);
            profileCircleImageView1.setVisibility(View.VISIBLE);
    ...
    public void setProfilePicFromPath(String path) {
        ...
        if (b == null) {
            ...
            if (b == null) {
                ...
                if (DEBUG)
                    Timber.e("Cant save image to backendless file path is invalid: " + activity.getCacheDir().getPath() + path);
                return;
            }
        }
    ...
    public void initViews() {
        if (mainView != null) {
            profileCircleImageView1 = (CircleImageView1) mainView.findViewById(R.id.chat_sdk_circle_ing_profile_pic);
    ...
    public CircleImageView1 getProfilePic() {
        return profileCircleImageView1;
    }
