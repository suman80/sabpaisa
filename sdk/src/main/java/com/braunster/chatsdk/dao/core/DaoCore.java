...
public class DaoCore {
    ...
    private static <T extends Entity> T fetchOrCreateEntityWithProperty(Class<T> c, Property property, Object value) {
...
//                e.printStackTrace();
    ...
    public static void connectUserAndThread(BUser user, BThread thread) {
        if (DEBUG)
            Timber.v("connectUserAndThread, User ID: %s, Name: %s, ThreadID: %s", +user.getId(), user.getMetaName(), thread.getId());
    ...
    public static void breakUserAndThread(BUser user, BThread thread) {
        if (DEBUG)
            Timber.v("breakUserAndThread, User ID: %s, Name: %s, ThreadID: %s", +user.getId(), user.getMetaName(), thread.getId());
    ...
    @SuppressWarnings("unchecked")
    private static <T extends Entity> T getEntityForClass(Class<T> c) {
        // Create the new entity.
        Class<T> clazz = null;
        T o = null;
        try {
