...
//        if (DEBUG) Log.d(TAG, "Message, Type: " + message.type  + " Row Type: " + type + ", Text: " + message.text);
    ...
    protected void inflateDefaults(ViewHolder holder, View row, boolean sender, MessageListItem message) {
        ...
        holder.profilePicImage = (CircleImageView1) row.findViewById(R.id.img_user_image);
     ...
     */
    private void loadProfilePic(final CircleImageView1 circleImageView1, final String url, final boolean sender) {

        if (url == null) {
            circleImageView1.setImageResource(R.drawable.ic_profile);
            return;
        }

        circleImageView1.setTag(url);
        ...
        VolleyUtils.getImageLoader().get(url, new ImageLoader.ImageListener() {
            ...
            public void onResponse(final ImageLoader.ImageContainer response, boolean isImmediate) {
                ...
                if (circleImageView1.getTag() != null && !circleImageView1.getTag().equals(url))
                    return;
                ...
                if (response.getBitmap() != null) {
                    if (!isScrolling) {
                        ...
                        animateSides(circleImageView1, !sender, new Animation.AnimationListener() {
                            @Override
                        ...
                        circleImageView1.getAnimation().start();
                    }
                }
            }
        ...
        }, circleImageView1.getWidth(), circleImageView1.getWidth());
    }
...
//                if (DEBUG) Timber.d("dimensions[0]: %s, dimensions[1]: %s", dimensions[0], dimensions[1]);
     ...
     */
    class ViewHolder {
        CircleImageView1 profilePicImage;
        TextView txtTime;
    ...
    private void animateSides(View view, boolean fromLeft, Animation.AnimationListener animationListener) {
        ...
        if (fromLeft)
            ...
            view.setAnimation(AnimationUtils.loadAnimation(mActivity, R.anim.expand_slide_form_right));
