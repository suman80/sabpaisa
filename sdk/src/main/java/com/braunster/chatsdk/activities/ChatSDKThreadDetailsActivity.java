...
public class ChatSDKThreadDetailsActivity extends ChatSDKBaseThreadActivity {
    ...
    private CircleImageView1 imageThread, imageAdmin;
    ...
    private void initViews() {
        ...
        imageAdmin = (CircleImageView1) findViewById(R.id.chat_sdk_admin_image_view);
        imageThread = (CircleImageView1) findViewById(R.id.chat_sdk_thread_image_view);
    }
            ...
            try {
                ...
                if (b == null) {
                    ...
                    if (b == null) {
                        ...
                        if (DEBUG)
                            Timber.e("Cant save image to backendless file path is invalid: %s",
