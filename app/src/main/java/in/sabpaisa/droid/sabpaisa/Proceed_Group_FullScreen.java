...
public class Proceed_Group_FullScreen extends AppCompatActivity {
    ...
    String GroupsNm,GroupsDiscription,GroupsImg,GroupId,response,userAccessToken;
...
//            loading.show();
    ...
    public void callGetCommentList(final String groupId) {
        //String urlJsonObj = AppConfiguration.MAIN_URL + "/getGroupsComments/" + GroupId;
        String tag_string_req="req_register";
        String urlJsonObj = AppConfiguration.GroupAddComment + "/getGroupsComments?group_id=" + groupId;
