...
public class SkipMainClientsAdapterForShare extends RecyclerView.Adapter<SkipMainClientsAdapterForShare.MyViewHolder> {
    ...
    public SkipMainClientsAdapterForShare(ArrayList<PersonalSpaceModel> institutions,Context context) {
