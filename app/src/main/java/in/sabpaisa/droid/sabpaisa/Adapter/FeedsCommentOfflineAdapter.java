...
public class FeedsCommentOfflineAdapter extends RecyclerView.Adapter<FeedsCommentOfflineAdapter.MyViewHolder> {

    private List<FeedCommentsOfflineModel> commentList;
    ...
    public FeedsCommentOfflineAdapter(List<FeedCommentsOfflineModel> countryList) {
        this.commentList = countryList;
    }

    @Override
    public void onBindViewHolder(MyViewHolder holder, int position) {
        FeedCommentsOfflineModel commentData = commentList.get(position);
