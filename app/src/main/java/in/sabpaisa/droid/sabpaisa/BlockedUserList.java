...
import in.sabpaisa.droid.sabpaisa.Adapter.BlockedUserListAdapter;
import in.sabpaisa.droid.sabpaisa.Adapter.PendingListOfUsersAdapter;
import in.sabpaisa.droid.sabpaisa.Model.Member_GetterSetter;
import in.sabpaisa.droid.sabpaisa.Util.AppConfig;
import in.sabpaisa.droid.sabpaisa.Util.FullViewOfClientsProceed;

public class BlockedUserList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isOnline()){
            fetchGroupUsersBlocked(clientId,groupId);
        }


    }

    private void fetchGroupUsersBlocked(final String clientId, final String groupId) {

        String tag_string_req = "req_register";
        String url = AppConfig.Base_Url+AppConfig.App_api+AppConfig.URL_fetchGroupUsers+"?clientId="+clientId+"&groupId="+groupId+"&status=Blocked";
        ...
        StringRequest jsonObjReq = new StringRequest(Request.Method.GET,
            ...
            public void onResponse(String response) {
                try {
                    ...
                    Log.d("BlockedUserList", "Resp_: " + response);
                    ...
                    if (status.equals("failure")) {
                        ...
                        blockedUserListAdapter = new BlockedUserListAdapter(member_getterSetterArrayList,BlockedUserList.this);
                        recycler_view_Member.setAdapter(blockedUserListAdapter);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Log.e("BlockedUserList", "Error"+error);
                    }
                }
        );
    ...
    public boolean isOnline() {
        ...
        if (cm.getActiveNetworkInfo() != null
            ...
            Log.v("BlockedUserList", "Internet Connection Not Present");
            return false;
        }
    }
