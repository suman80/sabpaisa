...
public class ProfileNavigationActivityFullViewProceed extends AppCompatActivity {
    private static final String TAG = ProfileNavigationActivityFullViewProceed.class.getSimpleName();
    ImageView userImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  CommonUtils.setFullScreen(this);
        ...
        ///////////////////////DB/////////////////////////////////
        db = new AppDB(ProfileNavigationActivityFullViewProceed.this);
        ...
        clientImageURLPath=i.getStringExtra("clientImageURLPath");
        state=i.getStringExtra("state");

Log.d("ProfileFullViewProceed","clientid"+clientId);
Log.d("ProfileFullViewProceed","image"+clientImageURLPath);
Log.d("ProfileFullViewProceed","state"+state);
    ...
    * */
    ...
    private void showProfileData() {
        ...
        if (res.getCount() > 0) {
            ...
            Log.d("getParticularNumFVP", "-->" + stringBuffer);
                    ...
                    try {
                        ...
                        if (status.equals("success")) {
                            ...
                            if (isInserted == true) {
                                ...
                                Log.d("ProfileNavigationFVP", "LocalDBInIfPart" + isInserted);

                            } else {
                                Log.d("ProfileNavigationFVP", "LocalDBInElsePart" + isInserted);
                ...
                try {
                    ...
                    if (status!=null && status.equals("success")) {
                        ...
                        if (isUpdated == true) {
                            ...
                            Log.d("ProfileNavigationFVP", "LocalDBInIfPart" + isUpdated);

                        } else {
                            Log.d("ProfileNavigationFVP", "LocalDBInElsePart" + isUpdated);
                            //Toast.makeText(ProfileNavigationActivity.this, "Data  Not Inserted", Toast.LENGTH_SHORT).show();
                        }
