...
public class Country {
    ...
    public static int getResId(String countryCode) {
        ...
        if (BuildConfig.DEBUG)
            Log.v(Country.class.getSimpleName(), String.format("getResId, Name: %s", drawableName));
        ...
        try {
            ...
            e.printStackTrace();
            if (BuildConfig.DEBUG)
                Log.e(Country.class.getSimpleName(), "cant get the drawable id for country code");
        }
        return -1;
    }
}